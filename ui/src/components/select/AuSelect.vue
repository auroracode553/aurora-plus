...
function normalizeSelectOptionNodes(nodes) {
  const groups = [];
  let optionSeed = 0;
  let groupSeed = 0;
  let looseGroup = null;
...
function findAdjacentEnabledOption(options, currentIndex, direction) {
...
<style scoped lang="scss" src="./AuSelect.scss"></style>
