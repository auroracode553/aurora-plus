...
function getPageCount({ pageCount, total, pageSize }) {
...
function buildPagerItems(currentPage, pageCount, pagerCount = 7) {
...
function parsePaginationLayout(layout) {
...
<style scoped lang="scss" src="./AuPagination.scss"></style>
